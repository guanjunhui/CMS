package cn.cebest.service.system.statistics.impl;
...
public class StatisticsService implements StatisticsManager{
	...
	public PageData findByIpAndDate(PageData pd) throws Exception{
		return (PageData)dao.findForObject("StatisticsMapper.findByIpAndDate", pd);
	}
	...
	public void updateCountByIpAndDate(PageData pd) throws Exception {
		dao.update("StatisticsMapper.updateCountByIpAndDate", pd);
	}
}

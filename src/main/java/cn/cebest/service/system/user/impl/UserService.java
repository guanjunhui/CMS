package cn.cebest.service.system.user.impl;
...
public class UserService implements UserManager{
	...
	public void changeStatus(PageData pd) throws Exception {
		dao.update("UserMapper.changeStatus", pd);
	}

	@Override
	public void deleteURole(String userId) throws Exception {
		dao.delete("UserMapper.deleteURole", userId);
	}

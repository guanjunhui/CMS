 ...
 * 查询没有资讯类型的所有资讯
 */
@Component("messageNoType_list")
public class MessageNullTypeListDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
		...
		try {
			...
			list = messageService.selectMessagelistPageNoTypeid(page);
		} catch (Exception e) {

 ...
 * 栏目详细标签
 */
@Component("product_peitaofuwu")
public class ProductPeiTaoFuWuDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		try {
			//根据产品Id和获取产品详情
			product = productService.findPeiTaoFuWuById(productId);
		} catch (Exception e) {
			logger.error("find the PeiTaoFuWuDirective by ID ["+productId+"]ocurred error!",e);
		}
		//设置输出变量

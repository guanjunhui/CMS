 ...
 * 查询对应类型下的所有资讯
 */
@Component("columnmessage_list")
public class MessageColumnListDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
		...
		try {
			...
			list = messageService.selectNewMessageByHotNew(page);
		} catch (Exception e) {

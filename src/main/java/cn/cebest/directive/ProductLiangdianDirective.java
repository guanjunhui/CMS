 ...
 * 栏目详细标签
 */
@Component("product_liangdian")
public class ProductLiangdianDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		try {
			//根据产品Id和获取产品详情
			product = productService.findProducLiangDianById(productId);
		} catch (Exception e) {

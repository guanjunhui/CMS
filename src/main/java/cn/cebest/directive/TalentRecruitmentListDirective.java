...
@Component("talentRecruitment_list")
public class TalentRecruitmentListDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		try {
			list = messageService.talentRecruitmentMessage(page);
		} catch (Exception e) {

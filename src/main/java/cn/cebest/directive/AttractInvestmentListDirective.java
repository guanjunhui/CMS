...
@Component("attractInvestment_list")
public class AttractInvestmentListDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		try {
			list = messageService.attractInvestmentMessage(page);
		} catch (Exception e) {

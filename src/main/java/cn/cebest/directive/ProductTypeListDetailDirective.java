 ...
 * 栏目详细标签
 */
@Component("product_type_list_detail")
public class ProductTypeListDetailDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		try {
			//根据产品Id和获取产品详情
			typeList = productService.findProductTypeList(productId);
		} catch (Exception e) {

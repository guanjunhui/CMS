...
@Component("newsHotAndRecommend_list")
public class NewsHotAndRecommendListDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		List<NewMessage> selectNewMessageByHotNew=null;
		try {
			selectNewMessageByHotNew = messageService.selectNewMessageByHotNew(page);
		} catch (Exception e) {
			logger.error("find the colum ocurred error!",e);
		}
		//设置输出变量
        env.setVariable(Const.OUT_LIST, getBeansWrapper().wrap(selectNewMessageByHotNew));

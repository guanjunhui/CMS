 ...
 * 根据栏目id查询内容分类列表
 */
@Component("contentType_list")
public class ContentTypeListDirective implements TemplateDirectiveModel {
...
//	private TxtService txtService;
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		pd.put("currentId", columId);
		pd.put("pid", pid);
		try {
			List<ContentType> content = contentService.findContentTypeList(pd);
			// 设置输出变量

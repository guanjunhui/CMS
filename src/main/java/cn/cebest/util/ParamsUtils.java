...
public abstract class ParamsUtils {
	 ...
	 */
	public static void addParamsToVariable(
	...
	public static String getString(String name,
		...
		if (model instanceof TemplateScalarModel) {
			...
			throw new IllegalArgumentException("dont get the param["+name+"]");
		}
	}
	...
	public static Integer[] getIntArray(String name,
			Map<String, TemplateModel> params) throws TemplateException {
		String str = ParamsUtils.getString(name, params);
	...
	public static Date getDate(String name, Map<String, TemplateModel> params)
		...
		if (model instanceof TemplateDateModel) {
			...
			DateConvert editor = new DateConvert();
	...
	public static InvokeType getInvokeType(Map<String, TemplateModel> params)
			throws TemplateException {
		String tpl = getString(Const.PARAM_TPL, params);
		if ("3".equals(tpl)) {

package cn.cebest.controller.system.fhdb;
...
import cn.cebest.portal.common.resolve.fetchshaoyin.FetchJob;
import cn.cebest.service.fhdb.timingbackup.TimingBackUpManager;
import cn.cebest.util.AppUtil;
import cn.cebest.util.DbFH;
import cn.cebest.util.Jurisdiction;
import cn.cebest.util.ObjectExcelView;
import cn.cebest.util.PageData;
import cn.cebest.util.QuartzManager;
...
public class TimingBackUpController extends BaseController {
	...
	@PostConstruct
	public void initJob(){
		String fetch=SystemConfig.getPropertiesString("fetch");
		if(StringUtils.isNotBlank(fetch)){
			String time=SystemConfig.getPropertiesString("time");
			QuartzManager.addJob("fetch_"+Tools.getRandomNum(), FetchJob.class, time);
		}
	}
}

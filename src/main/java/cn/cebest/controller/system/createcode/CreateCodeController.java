package cn.cebest.controller.system.createcode;
...
import cn.cebest.service.system.createcode.CreateCodeManager;
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		DelAllFile.delFolder(PathUtil.getUploadPath()+"admin/ftl"); //生成代码前,先清空之前生成的代码
		/* ============================================================================================= */
		...
		/*生成的全部代码压缩成zip文件*/
		if(FileZip.zip(PathUtil.getUploadPath()+"admin/ftl/code", PathUtil.getUploadPath()+"admin/ftl/code.zip")){
			/*下载代码*/
			FileDownload.fileDownload(response, PathUtil.getUploadPath()+"admin/ftl/code.zip", "code.zip");
		}
	}

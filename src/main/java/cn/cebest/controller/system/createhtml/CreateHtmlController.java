package cn.cebest.controller.system.createhtml;
...
import cn.cebest.service.web.aboutus.AboutusManager;
import cn.cebest.service.web.contactus.ContactusManager;
import cn.cebest.service.web.cooperation.CooperationManager;
import cn.cebest.service.web.corporatephilosophy.CorporatephilosophyManager;
import cn.cebest.service.web.image.ImageManager;
import cn.cebest.service.web.information.InformationManager;
import cn.cebest.service.web.news.NewsManager;
import cn.cebest.service.web.ourbusiness.OurBusinessManager;
import cn.cebest.util.AppUtil;
import cn.cebest.util.Const;
import cn.cebest.util.DelAllFile;
import cn.cebest.util.Freemarker;
...
public class CreateHtmlController extends BaseController {
	...
	public Object proCode(HttpServletResponse response) throws Exception{
		...
		DelAllFile.delFolder(PathUtil.getUploadPath()+"index.html"); //生成代码前,先清空之前生成的文件
	...
	public Object proAboutus(HttpServletResponse response) throws Exception{
		...
		DelAllFile.delFolder(PathUtil.getUploadPath()+"webaboutus.html"); //生成代码前,先清空之前生成的文件
	...
	public Object proProduct(HttpServletResponse response) throws Exception{
		...
		DelAllFile.delFolder(PathUtil.getUploadPath()+"webproduct.html"); //生成代码前,先清空之前生成的文件
	...
	public Object proCooperation(HttpServletResponse response) throws Exception{
		...
		DelAllFile.delFolder(PathUtil.getUploadPath()+"webcooperation.html"); //生成代码前,先清空之前生成的文件
	...
	public Object proNews(HttpServletResponse response) throws Exception{
		...
		DelAllFile.delFolder(PathUtil.getUploadPath()+"webnews.html"); //生成代码前,先清空之前生成的文件
	...
	public void proNewsdetail() throws Exception{
		...
		this.getInfo(root);				//网站基本信息
		this.getImg(root,"4");			//技术团队
		DelAllFile.delFolder(PathUtil.getUploadPath()+"webnewsdetail.html"); //生成代码前,先清空之前生成的文件
	...
	public Object proContactus(HttpServletResponse response) throws Exception{
		...
		DelAllFile.delFolder(PathUtil.getUploadPath()+"webcontactus.html"); //生成代码前,先清空之前生成的文件

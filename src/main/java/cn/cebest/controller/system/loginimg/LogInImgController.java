package cn.cebest.controller.system.loginimg;
...
import cn.cebest.service.system.loginimg.LogInImgManager;
...
public class LogInImgController extends BaseController {
	...
	public void delete(PrintWriter out) throws Exception{
		...
		DelAllFile.delFolder(PathUtil.getUploadPath()+ "static/login/images/" + pd.getString("FILEPATH")); //删除文件
		out.write("success");
		out.close();
	}

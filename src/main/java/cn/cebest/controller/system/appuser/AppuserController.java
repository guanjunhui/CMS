package cn.cebest.controller.system.appuser;
...
public class AppuserController extends BaseController {
	...
	@RequiresPermissions("happuser:goAddU")
	public ModelAndView goAddU() throws Exception{
		...
		mv.setViewName("system/appuser/appuser_add");
	...
	@RequiresPermissions("happuser:saveU")
	...
	@RequiresPermissions("happuser:deleteU")
	...
	public void changeStatus(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"改变会员状态");
		PageData pd = new PageData();
		pd = this.getPageData();
	...
	@RequiresPermissions("happuser:editU")
	...
	@RequiresPermissions("happuser:goEditU")
	...
	@RequiresPermissions("happuser:deleteAllU")
	@ResponseBody

package cn.cebest.controller.system.userphoto;
...
import cn.cebest.service.system.userphoto.UserPhotoManager;
	...
	public Object save() throws Exception{
		...
		if(null == ypd){			//没有数据就新增，否则就修改
			...
			if(Tools.notEmpty(PHOTO0)){
				DelAllFile.delFolder(PathUtil.getUploadPath()+ PHOTO0); //删除原图
			}
			DelAllFile.delFolder(PathUtil.getUploadPath()+ PHOTO1); //删除图1
			DelAllFile.delFolder(PathUtil.getUploadPath()+ PHOTO2); //删除图2
			DelAllFile.delFolder(PathUtil.getUploadPath()+ PHOTO3); //删除图3
		}

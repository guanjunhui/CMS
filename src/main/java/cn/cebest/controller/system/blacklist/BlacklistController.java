package cn.cebest.controller.system.blacklist;
...
public class BlacklistController extends BaseController {
	...
	@RequiresPermissions("blacklist:goAdd")
	public ModelAndView goAdd()throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/blacklist/blacklist_add");
	...
	@RequiresPermissions("blacklist:goEdit")
	...
	@RequiresPermissions("blacklist:deleteAll")
	@ResponseBody
	...
	@RequiresPermissions("blacklist:excel")

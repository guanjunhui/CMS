 ...
 * 创建时间：2014年6月28日
 */
public class PageXin<T> implements Serializable{
	
	@Value("${cms.pageSize}")  
    private String defaultPageSize;
	
	private static final long serialVersionUID = 5813023791706622386L;
	...
	private PageData pd = new PageData();//参数传递
    
	private T data;
	
	public PageXin(){
		try {
			this.showCount = Integer.parseInt(defaultPageSize);
		} catch (Exception e) {
			this.showCount = 15;
		}
	}
	
	public PageXin(int currentPage,int showCount){

...
<body class="no-skin">
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
					<!-- 检索  -->
					<form action="<%=adminPath%>pictures/${msg}" method="post" name="Form" id="Form">
							...
							<c:when test="${not empty varList}">
								...
								<c:forEach items="${varList}" var="var" varStatus="vs">
									<tr>
										...
										<td class="center">
										<a href="<%=adminPath%>uploadFiles/uploadImgs/${var.PATH}" title="${var.TITLE}" class="bwGal"><img src="<%=adminPath%>uploadFiles/uploadImgs/${var.PATH}" alt="${var.TITLE}" width="100"></a>
										</td>
	...
	<script type="text/javascript">
		...
		function del(Id,PATH){
			...
			if(confirm("确定要删除?")){ 
				top.jzts();
				var url = "<%=adminPath%>pictures/delete.do?PICTURES_ID="+Id+"&PATH="+PATH+"&tm="+new Date().getTime();

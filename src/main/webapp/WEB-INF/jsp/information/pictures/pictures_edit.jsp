		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="<%=adminPath%>pictures/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td>
										...
										<c:if test="${pd != null && pd.PATH != '' && pd.PATH != null }">
											<a href="<%=adminPath%>uploadFiles/uploadImgs/${pd.PATH}" target="_blank"><img src="<%=adminPath%>uploadFiles/uploadImgs/${pd.PATH}" width="210"/></a>

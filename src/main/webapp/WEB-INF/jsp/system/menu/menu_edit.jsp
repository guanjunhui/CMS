			...
			<div class="main-content-inner">
				<div class="page-content">
					...
					<div class="row">
						...
						<form  action="<%=adminPath%>menu/${MSG }.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 权限CODE : </label>
								<div class="col-sm-9">
									<input type="text" name="PERMISSION_CODE" id="PERMISSION_CODE" value="${pd.PERMISSION_CODE}" placeholder="这里输入权限值"  class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">

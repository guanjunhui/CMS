...
<body>
	...
	<div class="cms_con cf">
		...
		<form action="<%=adminPath%>happuser/saveU.do" name="Form" id="Form"
			method="post">
			...
			<div class="cms_c_list cf">
				...
				<div class="add_btn_con wrap cf">
						...
						<dd>
							<div class="dd_con">
								<input type="text" id="PHONE" name="PHONE" value="${pd.PHONE}"
									onblur="checkPhone();" class="required tel" /><span
					...
					<dl class="cf">
						<dt>
							<span class="hot">*</span>邮箱
						</dt>
						<dd>
							<div class="dd_con">
								<input type="text" id="EMAIL" name="EMAIL" value="${pd.EMAIL}"
									onblur="checkEmail();" class="required email" /><span
									class="warn_tip" style="display: none;"></span>
							</div>
						</dd>
					</dl>
				...
				<div class="all_btn cf">
					<input type="button" onclick="save('0');" class="submit_btn"
						value="保存" />  <a
						href="<%=adminPath%>happuser/listUsers.do" class="submit_re_btn">取消</a>
				</div>

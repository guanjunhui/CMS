...
function appendTypediv(list){
	 ...
	 $.each(list,function(index,obj){
		 html+='<li>';
		 	html+='<p><em class="show_btn"></em><label for="cc_'+obj.download_id+'"><input type="radio" att="'+obj.download_name+'" name="pid" value="'+obj.download_id+'" id="cc_'+obj.download_id+'" /><span>'+obj.download_name+'</span><i></i></label></p>';
		 	if(obj.childList!=null && obj.childList.length>0){
...
/* function sub(type){
	$("#TXT").val(getContent());
		...
		$.ajax({
			type: "POST",
			url:adminPath+"downloadType/save.do",
			data:formData,
			dataType:'json',
			cache: false,
	        processData: false,
		...
		<div class="left cf">
			...
			<i>></i> <i>添加分类</i>
				...
				<div class="cms_c_list cf">
					...
					<form name="productForm" action="<%=adminPath %>downloadType/save.do" id="Form" method="post" enctype="multipart/form-data" >
						...
						<div class="zhaopin zp_con01 cf">
							<dl class="cf zp_dl">
								...
								<dd><div class="dd_con"><input type="text" id="download_name" name="download_name" required><span id="type_nameSpan" class="warn_tip"></span></div></dd>
								<dd class="zp_dd">
									<label for="wlink"><input id="wlink" type="checkbox"><span>转向外部链接</span><i></i></label>
									<div class="dd_con"><input type="text" style="width:300px;" id="type_wburl" name="wburl" class="url"></div>
								</dd>
							</dl>
						</div>
								...
								<div class="dd_con" style="z-index:1;">
									<div class="eidt_box cf" style="z-index:1;">
										<table id="table_report" class="table table-striped table-bordered table-hover" style="z-index:1;">
												<tr>
													<td style="z-index:1;">
													  <script id="editor" type="text/plain" style="width:90.2%;height:240px;z-index:1;"></script>
													</td>
												</tr>
					...
					<span id="result"></span>
						...
						<a href="<%=adminPath%>/downloadType/list.do" class="submit_re_btn">取消</a>
					</div>
					<!-- 弹窗——相关内容 -->
					...
					<div class="layer_bg layer_bg02" style="display:none;">
						<div class="layer_con cf">
							...
							<div class="layer_list_other mScrol222 mScrol2223 cf">
								<ul id="columndiv">

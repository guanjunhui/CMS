...
function batchDel(param){
	...
	$.ajax({
		type: "GET",
		url:adminPath+"downloadExtendFiledController/delete.do",
		data:param,
		dataType:'json',
		cache: false,
		success:function(result){
...
function updateById(data){
	...
	window.location.href=adminPath+"downloadExtendFiledController/toUpdate.do?ID="+data; 
}
...
<body>
	...
	<div class="cms_con cf">
		...
		<form id="Form" action="<%=adminPath%>downloadExtendFiledController/list.do" method="post">
			<div class="cms_c_list biaoge_con chanpin_con cf">
				<div class="h3 cf">
					<div class="h3_left cf">
						<a href="<%=adminPath%>downloadExtendFiledController/toAdd.do">+添加属性</a>
					</div>
				</div>
				<div class="table cf">

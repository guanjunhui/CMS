...
<script type="text/javascript">
	$(function(){
		...
		$("#ss").click(function(){
			/* var $key=$("#key").val();
			$key=$.trim($key);
			window.location.href=adminPath+"contactPlan/countList.do?keywords="+encodeURI(encodeURI($key));  */
			$("#Form").submit();
		});
	});
	//当批量删除问题的时候提示是否删除
...
<body>
			...
			<div class="cms_con cf">
				...
				<form id="Form" action="<%=adminPath%>contactPlan/countList.do" method="post">
					...
					<div class="table cf">
						...
						<dl class="list_bg col_05 cf" id="did">
							<dt class="cf">
								...
								<div class="sele05">收藏量</div>
								<div class="sele05">点赞量</div>
							</dt>

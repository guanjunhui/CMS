<div id="sidebar" class="sidebar responsive">
				...
				<c:if test="${menu1.hasMenu && '1' == menu1.MENU_STATE}">
					<li class=""  id="lm${menu1.MENU_ID }">
						...
						<b class="arrow"></b>
						<c:if test="${'[]' != menu1.subMenu && not empty menu1.subMenu && fn:length(menu1.subMenu) > 0}">
						<ul class="submenu">
						<c:forEach items="${menu1.subMenu}" var="menu2">
							...
							<li class="" id="z${menu2.MENU_ID }">
								...
								<b class="arrow"></b>
								<c:if test="${'[]' != menu2.subMenu  && not empty menu2.subMenu && fn:length(menu2.subMenu) > 0}">
								<ul class="submenu">

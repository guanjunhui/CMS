...
function sub(type){
		...
		$.ajax({
			type: "POST",
			url:adminPath+"messageExtendWord/save.do",
			data:{name:name,fieldtype:fieldType},
			...
			<div class="cms_con cf">
				<div class="cms_c_inst neirong cf">
					<div class="left cf">
						...
						<i>></i>
						<a href="<%=adminPath%>messageExtendWord/list.do">扩展管理</a>
						<i>></i>
						<i>添加扩展字段</i>
					</div>
				</div>
						...
						<div class="add_btn_con wrap cf">
							...
							<div class="zhaopin zp_con01 cf">
								<dl class="cf zp_dl">
									...
									<dd><div class="dd_con"><input type="text" id="pname" name="name" required><span id="nameSpan" class="warn_tip"></span></div></dd>
								</dl>
							</div>

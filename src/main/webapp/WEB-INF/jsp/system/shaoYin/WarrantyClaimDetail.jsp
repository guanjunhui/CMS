	...
	<!-- cms_con开始 -->
				<div class="cms_con cf">
					...
					<div class="left cf">
						...
						<i>></i>
						<a href="<%=adminPath%>/warrantyClaim/list.do">表单列表</a>
						<i>></i>
						<i>详情</i>
					</div>
				</div>	
				<div class="add_btn_con wrap cf">
					<div class="zhaopin zp_con01 cf">
						<dl class="cf">
							...
							<dd>
								<div class="dd_con">
									<input type="text" value="${data.registrationCode}">
								</div>		
							</dd>
						</dl>
						<dl class="cf">
						...
						<dl class="cf">
							...
							<dd>
								<div class="dd_con">
									<input type="text" value="${data.problem}">
								</div>		
							</dd>
						</dl>
						<dl class="cf">
							...
							<dd>
								<div class="dd_con">
									<ul><li>
									<textarea class="textarea_numb right" name="" style="width:50%;">${data.comments}</textarea>
									</li></ul>
								</div>		
							</dd>
						</dl>
						<dl class="cf">
							...
							<dd>
								<div class="dd_con">
									<input type="text" value="${data.resolve}">
								</div>		
							</dd>
						</dl>
						<dl class="cf">
							...
							<dd>
								<div class="dd_con">
									<input type="text" value="${data.submitTime}">
								</div>		
							</dd>
						</dl>
...
<script type="text/javascript">
	function cancel(){
		window.location.href = "<%=adminPath%>/warrantyClaim/list.do";
	}
</script>
</html>
...
<script type="text/javascript">
	...
	function deleteChecks(){
		...
		window.location.href=adminPath+"webUser/deletes.do?id="+ids.toString();		
	}
	
	//通过id删除数据
	function deleteById(data){
		window.location.href=adminPath+"webUser/delete.do?id="+data;
	}
	//根据id查看详情
	function detailById(id){
		window.location.href=adminPath+"webUser/detailById.do?id="+id;
	}
	//当删除问题的时候提示是否删除

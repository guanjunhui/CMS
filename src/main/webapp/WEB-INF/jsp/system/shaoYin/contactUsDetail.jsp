	...
	<!-- cms_con开始 -->
				...
				<div class="add_btn_con wrap cf">
					...
					<dl class="cf">
						...
						<dd>
							<div class="dd_con">
								<input type="text" value="${data.unitedStatus}">
							</div>		
						</dd>
					</dl>
					<dl class="cf">
					...
					<dl class="cf">
						...
						<dd>
							<div class="dd_con">
								<ul><li>
								<textarea class="textarea_numb right" name="" style="width:50%;">${data.description}</textarea>
								</li></ul>
							</div>		
						</dd>
					</dl>
...
<script type="text/javascript">
	function cancel(){
		window.location.href = "<%=adminPath%>/contactUs/list.do";
	}
</script>
</html>
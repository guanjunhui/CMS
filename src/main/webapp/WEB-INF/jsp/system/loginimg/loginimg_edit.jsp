		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="<%=adminPath%>loginimg/${msg }.do" name="Form" id="Form" method="post">
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$(document).ready(function(){
			...
			$("#uploadify1").uploadify({
				'buttonImg'	: 	"<%=adminPath%>plugins/uploadify/uploadp.png",
				'uploader'	:	"<%=adminPath%>plugins/uploadify/uploadify.swf",
				'script'    :	"<%=adminPath%>plugins/uploadify/uploadFile.jsp;jsessionid="+jsessionid,
				'cancelImg' :	"<%=adminPath%>plugins/uploadify/cancel.png",
				'folder'	:	"<%=adminPath%>static/login/images",//上传文件存放的路径,请保持与uploadFile.jsp中PATH的值相同
				'queueId'	:	"fileQueue",

...
<body class="no-skin">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="<%=adminPath%>loginimg/list.do" method="post" name="Form" id="Form">
						</from>
								...
								<c:when test="${not empty varList}">
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'><img src="<%=adminPath%>static/login/images/${var.FILEPATH}" width="100" /></td>
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=adminPath%>loginimg/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 335;
		...
		function del(Id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=adminPath%>loginimg/delete.do?LOGINIMG_ID="+Id+"&tm="+new Date().getTime();
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=adminPath%>loginimg/goEdit.do?LOGINIMG_ID='+Id;
			 diag.Width = 450;
			 diag.Height = 220;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮

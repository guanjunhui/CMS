...
<base href="<%=basePath%>">
	...
	<!-- 表单构建组建 -->
	<link rel="shortcut icon" href="staticRelease/images/back/favicon.ico"> <link href="plugins/fhform/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
...
<body class="gray-bg">
	...
	<div class="main-container" id="main-container">
		...
		<form action="<%=adminPath%>/tool/downloadFormCode.do" name="Form" id="Form" method="post">

		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="<%=adminPath%>dictionaries/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover" style="margin-top:15px;">
							...
							<tr>
								...
								<td><input type="text" name="VALUE" id="VALUE" value="${pd.VALUE}" maxlength="32" placeholder="这里输入文本值 " title="内容" <c:if test="${null != pd.VALUE}">readonly="readonly"</c:if> style="width:76%;" /></td>
							</tr>
							<tr>

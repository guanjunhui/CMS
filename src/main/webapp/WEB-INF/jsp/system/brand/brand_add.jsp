	...
	<div class="cms_con cf">
		<div class="cms_c_inst neirong cf">
			<div class="left cf">
				...
				<i>></i> <a href="<%=adminPath%>brand/list.do">分组管理</a> <i>></i> <i>添加分组</i>
			</div>
		</div>
				...
				<div class="add_btn_con wrap cf">
					...
					<div class="zhaopin zp_con01 cf">
						<dl class="cf zp_dl">
							...
							<dd>
								<div class="dd_con">
									<input type="text" id="bname" name="name" required><span id="nameSpan" class="warn_tip"></span>
								</div>
							</dd>
						</dl>
					</div>

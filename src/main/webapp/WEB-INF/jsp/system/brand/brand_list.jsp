...
function updateById(data){
	...
	window.location.href=adminPath+"brand/toUpdate.do?id="+data; 
}
...
<body>
	...
	<div class="cms_con cf">
		...
		<form id="Form" action="<%=adminPath%>brand/list.do" method="post">
			<div class="cms_c_list biaoge_con chanpin_con cf">
				<div class="h3 cf">
					<div class="h3_left cf">
						<a href="<%=adminPath%>brand/toAdd.do">+添加分组</a>
					</div>
				</div>
				<div class="table cf">

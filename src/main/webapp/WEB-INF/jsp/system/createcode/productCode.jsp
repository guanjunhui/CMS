...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
					...
					<form action="<%=adminPath%>createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td>&nbsp;&nbsp;例如:cn.cebest.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;只输入红色部分</td>

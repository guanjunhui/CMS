	...
	<script type="text/javascript">
		...
		function connDb(){
			...
			if("" == databaseName){
			 ...
			 $.ajax({
					type: "POST",
					url: '<%=adminPath%>recreateCode/listAllTable.do?tm='+new Date().getTime(),
		...
		function productCode(table){
			...
			databaseName = databaseName.replace("#","%23");
			 ...
			 diag.Drag=true;
			 diag.Title ="代码生成器";
			 diag.URL = '<%=adminPath%>recreateCode/goProductCode.do?table='+table+'&dbtype='+dbtype+'&dbAddress='+dbAddress+'&dbport='+dbport+'&username='+username+'&password='+password+'&databaseName='+databaseName;
			 diag.Width = 800;
			 diag.Height = 500;

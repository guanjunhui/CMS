...
function appendTypediv(list){
	...
	html+='<li>';
	 html+='<p><em class="show_btn"></em><label for="cc_0"><input id=cc_0 type="radio" att="顶级属性" name="pid" value="0"  /><span>作为顶级属性</span><i></i></label></p>';
	 html+='</li>';
...
function sub(type){
		...
		$.ajax({
			type: "POST",
			url:adminPath+"property/save.do",
				...
				<div class="add_btn_con wrap cf">
					...
					<div class="zhaopin zp_con01 cf">
						<dl class="cf zp_dl">
							...
							<dd>
								<div class="dd_con">
									<input type="text" id="pname" name="name" required><span

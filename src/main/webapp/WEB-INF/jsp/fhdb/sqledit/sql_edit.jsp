	...
	<script type="text/javascript">
		...
		function executeUpdate(){
			...
			if("" == sql){
			 ...
			 $.ajax({
					type: "POST",
					url: '<%=adminPath%>sqledit/executeUpdate.do?tm='+new Date().getTime(),
			    	data: {sql:sql},
					dataType:'json',
	...
	<script type="text/javascript">
		...
		function executeQuery(){
			...
			if("" == sql){
			 ...
			 $.ajax({
					type: "POST",
					url: '<%=adminPath%>sqledit/executeQuery.do?tm='+new Date().getTime(),
			    	data: {sql:sql},
					dataType:'json',
					//beforeSend: validateData,
					cache: false,
		...
		function toExcel(){
			...
			if("" == sqlstrforExcel){
				...
				window.location.href='<%=adminPath%>sqledit/excel.do?sql='+sqlstrforExcel;
			}
		}
	</script>
	</c:if>

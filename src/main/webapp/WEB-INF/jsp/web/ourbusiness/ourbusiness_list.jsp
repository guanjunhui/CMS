...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="<%=adminPath%>ourbusiness/list.do" method="post" name="Form" id="Form">
						<!-- 检索  -->
	...
	<script type="text/javascript">
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=adminPath%>ourbusiness/goEdit.do?OURBUSINESS_ID='+Id;
			 diag.Width = 800;
			 diag.Height = 615;

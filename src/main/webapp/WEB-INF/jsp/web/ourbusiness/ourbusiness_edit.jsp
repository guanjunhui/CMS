		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="<%=adminPath%>ourbusiness/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">(模版2)图1:</td>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">(模版2)图2:</td>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function xuanTp(ID){
			 ...
			 diag.Drag=true;
			 diag.Title ="选择图片";
			 diag.URL = '<%=adminPath%>pictures/listfortc.do';
			 diag.Width = 860;
			 diag.Height = 680;

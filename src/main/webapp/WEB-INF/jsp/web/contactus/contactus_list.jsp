...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="<%=adminPath%>contactus/list.do" method="post" name="Form" id="Form">
						<!-- 检索  -->
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=adminPath%>contactus/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 410;
		...
		function del(Id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=adminPath%>contactus/delete.do?CONTACTUS_ID="+Id+"&tm="+new Date().getTime();
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=adminPath%>contactus/goEdit.do?CONTACTUS_ID='+Id;
			 diag.Width = 600;
			 diag.Height = 400;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮

! function(a) {
	a.fn.gridQuote = function(b) {
		function r() {
			clearInterval(d.data("_slideshowID")), p = function() {
				var a = h.data("index");
				a++, a > g.length - 1 && (a = 0), g[a].trigger("click")
			}, d.data("_slideshowID", p)
		}
...
//				scrollTop: h.offset().top
		...
		d.find(".thumb-container").each(function(b) {
			...
			var s = a(this).data("fontsize") || c.titleFontSize,
				t = a(this).data("bgcolor") || c.defaultBgColor;
			p.addClass(t).find(".popover-content").css("font-size", s), a(this).on("click", function() {
				for(var d = 0; k >= d; d++) a(this).data("row") == d && g[Math.min((d + 1) * j + d, g.length - 1)].after(e);
				var m, f = a(this).find(".quote-container").html();
				a(this).is(h) ? l ? (e.fadeOut(300), o && o.stop(!0).animate({
					opacity: 0
				}, 300, function() {
					a(this).hide()
				}), l = !1) : (e.show().fadeIn(300), o && o.show().stop(!0).animate({
					opacity: 1
				...
				}) : e.show().html(f).fadeIn(300), i = e.offset().top, m = a(this).find(".popover"), m.find(".arrow").hide().css("opacity", 1), m.hide().stop(!0).animate({
					opacity: 1
			...
			if(!navigator.userAgent.match(/(iPod|iPhone|iPad)/) && !a(this).is(h)) {
				...
				c.find(".arrow").hide().css("opacity", 0), c.hide().css({
					opacity: 0
				}).animate({
					opacity: 1
				}, 400)

...
<%
	...
	String basePath = "//"+request.getServerName()+path+"/static/";
%>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<body class="no-skin">
	...
	<script type="text/javascript">
		window.jQuery || document.write("<script src='<base href="<%=basePath%>">static/ace/js/jquery.js'>"+"<"+"/script>");
	</script>
	<!-- <![endif]-->
	<!--[if IE]>
	<script type="text/javascript">
	 window.jQuery || document.write("<script src='<base href="<%=basePath%>">static/ace/js/jquery1x.js'>"+"<"+"/script>");
	</script>
	<![endif]-->
	<script type="text/javascript">
		if('ontouchstart' in document.documentElement) document.write("<script src='<base href="<%=basePath%>">static/ace/js/jquery.mobile.custom.js'>"+"<"+"/script>");
	</script>
